...
I'm a **Backend Developer** focused on building scalable, high-performance microservices. My passion is using technology to solve complex problems by applying solid software architecture practices.
  ...
  - 💼 **Backend Developer (Intern)** at **ICRO Digital** (04/2025 - present), working on the development and maintenance of robust microservices with TypeScript, NestJS, TypeORM, and PostgreSQL.
  ...
  - 🧪 I believe in code quality, which is why I implement unit tests with **Jest** and mutation testing with **Stryker**.
  - 📌 My previous experiences include **Full Stack Development** at the **Federal Court of Accounts (TCU)** and technical support at UNIFAL's IT Center (NTI).
  - 🌱 I am always eager to learn and evolve: I am currently strengthening my knowledge in **Java with Spring** and plan to study the **.NET** platform in the future.
